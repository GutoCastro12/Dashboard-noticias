[README.md](https://github.com/user-attachments/files/30242470/README.md)
...
**Tabela de auditoria.** O arquivo `auditoria_grupos_ativos.csv` lista os 73 emissores com nome, ticker, tipo cadastral, subgrupo atribuído/esperado e status (ok/revisar).
